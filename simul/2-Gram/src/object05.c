 ...
 * @file object05.c
 *
 * Port of fft from the MRTC benchmarks
 */
...
static double object(5) fabs(double n)
{
  double f;
...
static double object(5) log(double n)
{
   double result=1.0;
...
static double object(5) sin(double rad)
{
  double app;
...
static double object(5) cos(double rad)
{
  double sin();
...
int object(5) fft1(int n, int flag)
{
